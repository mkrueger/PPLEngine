...
impl Add<VariableValue> for VariableValue {
    ...
    fn add(self, other: VariableValue) -> Self {
        match self {
            ...
            VariableValue::String(x) => match other {
...
pub fn convert_to(var_type: VariableType, value: &VariableValue) -> VariableValue {
    match var_type {
        ...
        VariableType::Unsigned => match value {
            ...
            VariableValue::Boolean(v) => VariableValue::Unsigned(if *v {
                PPL_TRUE as u32
            } else {
                PPL_FALSE as u32
            }),
        ...
        VariableType::Word => match value {
            ...
            VariableValue::Boolean(v) => VariableValue::Word(if *v {
                PPL_TRUE as u16
            } else {
                PPL_FALSE as u16
            }),
        ...
        VariableType::SWord => match value {
            ...
            VariableValue::Boolean(v) => VariableValue::SWord(if *v {
                PPL_TRUE as i16
            } else {
                PPL_FALSE as i16
            }),
        ...
        VariableType::Real => match value {
            ...
            VariableValue::Boolean(v) => VariableValue::Real(if *v {
                PPL_TRUE as f64
            } else {
                PPL_FALSE as f64
            }),
        ...
        VariableType::Money => match value {
